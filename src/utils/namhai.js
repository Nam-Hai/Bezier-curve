...
N.RO = class {
  constructor() {
    this.eT = N.Snif.isMobile ? "orientationchange" : "resize", this.tick = !1, this.arr = [], N.BM(this, ["fn", "gRaf", "run"]), this.t = new N.Timer({
      delay: 100,
      cb: this.gRaf
    }), this.raf = new N.RafR(this.run), N.L(window, "a", this.eT, this.fn)
  }
  add(t) {
    this.arr.push(t)
  }
